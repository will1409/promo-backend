...
async function test() {
  ...
  const query = 'query { productOfferV2(keyword: "Kit AMD Ryzen 7 5700X e Placa Mãe B550M Aorus Elite Bios Atualizada...", listType: 0, sortType: 1, limit: 1) { nodes { productName price imageUrl } } }'; 
